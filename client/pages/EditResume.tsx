  ...
  return (
    <div className="flex flex-col h-screen bg-slate-50">
      ...
      <div className="border-b border-slate-200 bg-white px-4 md:px-6 py-4">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <Button variant="outline" onClick={() => navigate('/resume')} size="sm" className="border-slate-300">
              ← Back
            </Button>
            <div className="border-l border-slate-200 pl-3">
              <h1 className="text-base md:text-lg font-semibold text-slate-900">Resume Builder</h1>
              <p className="text-xs text-slate-500">Professional Resume</p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2 justify-end">
            ...
            <Button
              ...
              className="bg-green-700 hover:bg-green-800 text-white text-xs font-semibold px-4"
            >
              {saving ? (
                <>
            ...
            <Button
              ...
              className="text-xs bg-green-700 hover:bg-green-800 text-white px-3"
            >
              <Sparkles size={14} className="mr-1.5" />
              <span className="hidden sm:inline">Find </span>Smart Trades
            </Button>
            ...
            >
              {scanning ? (
                ...
                <>
                  ...
                  <span className="hidden sm:inline">Scan </span>Resume
                </>
              )}
            </Button>

            <Button size="sm" onClick={handlePrint} className="text-xs bg-green-700 hover:bg-green-800 text-white px-3">
            ...
            <Button
              ...
              className="text-xs bg-green-700 hover:bg-green-800 text-white px-3"
            >
              <span className="hidden sm:inline">Clear </span>Form
            </Button>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-hidden flex flex-col lg:flex-row">
        ...
        <div className={`w-full lg:w-1/2 overflow-y-auto overflow-x-hidden bg-white border-b lg:border-b-0 lg:border-r border-slate-200 ${showMobilePreview ? 'hidden lg:block' : 'block'}`}>
          <div className="p-4 md:p-6 space-y-5 max-w-2xl mx-auto">
            ...
            <Card className="border-slate-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <CardContent className="space-y-5 pt-5">
                <div>
                  <Label className="text-xs font-semibold text-slate-700 mb-2 block">Resume Template</Label>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label className="text-xs font-semibold text-slate-700 mb-2 block">Spacing</Label>
                  ...
                  <div>
                    <Label className="text-xs font-semibold text-slate-700 mb-2 block">Accent Color</Label>
                    <div className="flex gap-2 mt-2">
                      {[
                        ...
                        <button
                          ...
                          className={`w-9 h-9 rounded-lg border-2 transition-all hover:scale-110 flex items-center justify-center ${accentColor === color ? 'border-slate-400 ring-2 ring-offset-2 ring-indigo-200' : 'border-slate-200 hover:border-slate-300'
                            }`}
                          style={{ backgroundColor: color }}
                          title={name}
                        >
                          {accentColor === color && <span className="text-white text-xs">✓</span>}
                        </button>
                      ))}
                    </div>
                  </div>
            ...
            <div className="space-y-2">
              ...
              <Accordion type="single" collapsible defaultValue="basics" className="space-y-2">
                ...
                <AccordionItem value="basics" className="border border-slate-200 rounded-md bg-white px-4 hover:border-slate-300 transition-all">
                  <AccordionTrigger className="text-sm font-semibold text-slate-800 hover:text-slate-900 hover:no-underline">
                    <div className="flex items-center gap-2">
                  ...
                  <AccordionContent className="space-y-3 pt-4 pb-2">
                    <div className="grid grid-cols-2 gap-3">
                      <div><Label className="text-xs">Full Name *</Label><Input value={resume.full_name || ""} onChange={e => update('full_name', e.target.value)} className="mt-1" /></div>
                      <div><Label className="text-xs">Professional Title</Label><Input value={resume.headline || ""} onChange={e => update('headline', e.target.value)} placeholder="e.g. Software Engineer" className="mt-1" /></div>
                      <div><Label className="text-xs">Email *</Label><Input type="email" value={resume.email || ""} onChange={e => update('email', e.target.value)} className="mt-1" /></div>
                      <div><Label className="text-xs">Phone *</Label><Input value={resume.phone || ""} onChange={e => update('phone', e.target.value)} className="mt-1" /></div>
                      <div className="col-span-2"><Label className="text-xs">Location</Label><Input value={resume.location || ''} onChange={e => update('location', e.target.value)} placeholder="City, State" className="mt-1" /></div>
                    </div>
                  </AccordionContent>
                </AccordionItem>

                <AccordionItem value="summary" className="border border-slate-200 rounded-md bg-white px-4 hover:border-slate-300 transition-all">
                  <AccordionTrigger className="text-sm font-semibold text-slate-800 hover:text-slate-900 hover:no-underline">
                    <div className="flex items-center gap-2">
                      <FileText size={16} className="text-slate-600" />
                  ...
                  <AccordionContent className="pt-3">
                    <Textarea rows={4} value={resume.summary || ''} onChange={e => update('summary', e.target.value)} placeholder="Write a compelling 2-3 sentence summary highlighting your key strengths and experience..." />
                    <div className="flex justify-end mt-2">
                      <Button variant="ghost" size="sm" className="text-xs text-indigo-600" onClick={async () => {
                ...
                <AccordionItem value="experience" className="border border-slate-200 rounded-md bg-white px-4 hover:border-slate-300 transition-all">
                  <AccordionTrigger className="text-sm font-semibold text-slate-800 hover:text-slate-900 hover:no-underline">
                    <div className="flex items-center gap-2">
                ...
                <AccordionItem value="education" className="border border-slate-200 rounded-md bg-white px-4 hover:border-slate-300 transition-all">
                  <AccordionTrigger className="text-sm font-semibold text-slate-800 hover:text-slate-900 hover:no-underline">
                    <div className="flex items-center gap-2">
                ...
                <AccordionItem value="skills" className="border border-slate-200 rounded-md bg-white px-4 hover:border-slate-300 transition-all">
                  <AccordionTrigger className="text-sm font-semibold text-slate-800 hover:text-slate-900 hover:no-underline">
                    <div className="flex items-center gap-2">
                ...
                <AccordionItem value="projects" className="border border-slate-200 rounded-md bg-white px-4 hover:border-slate-300 transition-all">
                  <AccordionTrigger className="text-sm font-semibold text-slate-800 hover:text-slate-900 hover:no-underline">
                    <div className="flex items-center gap-2">
                      <FolderGit2 size={16} className="text-slate-600" />
                      Projects (Optional)
                    </div>
                  </AccordionTrigger>
                  <AccordionContent className="pt-3">
                ...
                <AccordionItem value="languages" className="border border-slate-200 rounded-md bg-white px-4 hover:border-slate-300 transition-all">
                  <AccordionTrigger className="text-sm font-semibold text-slate-800 hover:text-slate-900 hover:no-underline">
                    <div className="flex items-center gap-2">
                ...
                <AccordionItem value="volunteer" className="border border-slate-200 rounded-md bg-white px-4 hover:border-slate-300 transition-all">
                  <AccordionTrigger className="text-sm font-semibold text-slate-800 hover:text-slate-900 hover:no-underline">
                    <div className="flex items-center gap-2">
