                      ...
                      <div className="flex items-center justify-between mb-1">
                        ...
                        {user && (comment.user_id === user.id || user.id === postOwnerId) && (
                          <div className="relative group">
                            ...
                            <div className="absolute right-0 top-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10 w-24">
                              <button
